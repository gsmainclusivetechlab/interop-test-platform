...
class FaqController extends Controller
{
    ...
    public function index()
    {
        return Inertia::render('admin/faqs/index', [
            'faqs' => FaqResource::collection(Faq::latest()->paginate()),
        ]);
    }
    ...
    public function import(Request $request)
    {
        ...
        try {
            ...
            return redirect()
                ...
                ->with(
                    'success',
                    __('FAQ imported successfully. Don\'t forget to activate.')
                );
    ...
    public function export(Faq $faq)
    {
        ...
        return response()->streamDownload(function () use ($faqData) {
            echo $faqData;
        }, 'faq.yaml');
    }

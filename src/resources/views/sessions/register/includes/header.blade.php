...
<div class="row d-flex justify-content-center">
    <div class="col-md-8">
        <div class="steps steps-counter steps-primary">
            <span class="step-item @if (request()->routeIs('sessions.register.selection.*')) active @endif">
                <span class="d-inline-block mt-2">{{ __('Select SUT') }}</span>
            </span>
            <span class="step-item @if (request()->routeIs('sessions.register.configuration.*')) active @endif">
                <span class="d-inline-block mt-2">{{ __('Configure SUT') }}</span>
            </span>
            <span class="step-item @if (request()->routeIs('sessions.register.information.*')) active @endif">

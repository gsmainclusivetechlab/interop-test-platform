        ...
        <form class="card card-md" @submit.prevent="submit">
            <div class="card-body">
                ...
                <div class="form-footer">
                    <button type="submit" class="btn btn-primary btn-block">Send me password reset link</button>
                </div>
            </div>
        </form>
...
<script>
    ...
    export default {
        ...
        methods: {
            submit() {
                this.sending = true;
                this.$inertia.post(route('password.email'), this.form).then(() => this.sending = false);
            },
        },
    }
</script>
